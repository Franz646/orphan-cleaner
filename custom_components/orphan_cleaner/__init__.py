...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    frontend.async_register_built_in_panel(
        ...
        config={
            "_panel_custom": {
                ...
                "js_url": "/api/orphan_cleaner/orphan-cleaner-panel.js?v=1.1.0",
                "embed_iframe":  False,
    ...
    _LOGGER.info("Orphan Entity Cleaner loaded successfully")
    return True
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    _LOGGER.info("Orphan Entity Cleaner unloaded")
    return True
